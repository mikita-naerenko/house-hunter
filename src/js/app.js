...
const renderRoomTourSection = function(roomTourArr) {
    let currentTour = 0;
    ...
    const htmlSaller = `<div class="saller saller--room-tour">
                    <picture><img srcset="${roomTourArr[currentTour].saller.avatar}"  width="40" alt=""></picture>
                    <div class="slide__wrapper">
    ...
    const htmlMainPhoto = `<img srcset="${roomTourArr[currentTour].photoList.slice(0, 1)}" width="60" height="60" alt="" class="show-photo__item show-photo__item--main">`;
    ...
    roomTourArr[currentTour].photoList.slice(1, 4).forEach((img, i) => {
        let html;
        i === 0 ? html = `<img srcset="${img}" width="60" height="60" alt="" class="show-photo__item show-photo__item--next">`
        : html = `<img srcset="${img}" width="60" height="60" alt="" class="show-photo__item"></img>`;
